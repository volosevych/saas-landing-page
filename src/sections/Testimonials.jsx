...
const Testimonials = () => {
  ...
  return <section className='relative z-2 py-24 md:py-28 lg:py-40'>
    <div className='container block lg:flex'>
        ...
        <div className='testimonials_inner-after testimonials_inner-before relative -my-12 -mr-3 flex items-start
        max-lg:static max-md:block'>
